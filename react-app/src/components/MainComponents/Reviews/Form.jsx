...
<div className="namecheck">
  ...
  <input name="username" placeholder="Имя и фамилия" type="text" className="input control form__name form__text"/>
...
<div className="ratingcheck">
  ...
  <input name="ratingform" placeholder="Оценка" type="number" className="rating2 control form__rating form__text"/>
...
<div className="form__second-row">
  ...
  <textarea name="review2" placeholder="Текст отзыва" className="review12345 form__review form__text"></textarea>
</div>
</div>
